export const SOOS_DAST_CONSTANTS = {
  AuthDelayTime: 5,
  Tool: "zap",
  ToolVersion: "2.17.0", // NOTE: this should match the zap-stable version in the Docker file
  Files: {
  ...
  ObfuscatedArguments: ["apiKey", "authUsername", "authPassword", "bearerToken", "requestHeaders"],
};
